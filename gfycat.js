...
var GfyCat = angular.module('GfyCat', []);

GfyCat.controller('GfyController', function ($scope, $http) {
   ...
   $http.get(url)
      .then(function(response) {
         $scope.gifs = response.data.gfycats;
...
GfyCat.filter('trustUrl', ['$sce', function ($sce) {
   return function (url) {
